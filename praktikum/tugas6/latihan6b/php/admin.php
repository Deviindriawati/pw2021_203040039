...
<body>
    ...
    <div class="container">
        ...
        <table class="centered highlight - white-text Bisque darken-3">
            <tr class="z-depth-5 Beige darken-3 white-text">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="hapus.php?id=<?=$nvl['id']?>"
                        class="waves-effect waves-light Bis darken-3 btn-small">Hapus</a>
                </td>
            </tr>
            <?php $i++?>
            <?php endforeach;?>
