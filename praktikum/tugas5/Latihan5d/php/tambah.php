...
<body style="font-family: Arial, sans-serif;">
    ...
    <form action="" method="post">
        <ul style="list-style: none;">
            ...
            <li>
                <label for="penulis" style="margin-right: 16px;">Masukan nama penulis novel</label>
                : <input type="text" name="penulis" id="penulis" require><br><br>
            </li>
            <li>
                <label for="penerbit" style="margin-right: 21px;">Masukan nama penerbit novel</label>
                : <input type="text" name="penerbit" id="penerbit" require><br><br>
            </li>
            <li>
